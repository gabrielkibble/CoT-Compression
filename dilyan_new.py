    ...
    for method in methods:
        ...
        console.print(
            Panel.fit(
                ...
                + (
                    "Best-3 Consensus + continuous reasoning rank fusion: same best-3 answer-targeted latent geometry and log P(R_-i|Q), but NO safe pool; delete by percentile-rank(geometry) * percentile-rank(reasoning)"
